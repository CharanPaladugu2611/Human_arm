...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'human_gripper.urdf'
    xacro_file = "human_gripper.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "human_gripper"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("human_gripper"), "rviz", "display_default.rviz"]
    )
